...
class UlasanPolicy
{
    ...
    {
        return $user->can('view_any_ulasan');
    }
    ...
    {
        return $user->can('delete_any_ulasan');
    }
     ...
     */
    public function replicate(User $user, Ulasan $ulasan): bool
    {
